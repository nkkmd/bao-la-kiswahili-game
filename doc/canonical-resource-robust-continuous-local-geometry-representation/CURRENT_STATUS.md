...
```text
Study = CRCLGR-STUDY1
Status = CLOSED / FORMAL-ELIGIBLE-RESOURCE-BOUNDED-CONTINUOUS-REPRESENTATION
Representation = CRCLGR-R1-EXACT-SQUASHED-L1
Stage 0 = STAGE0-PASS
Stage 1 = STAGE1-PASS / 1 authorized / 1 actual
Stage 1 seed block = 32110001..32110256 / CONSUMED / NO RERUN
Stage 2 = FORMAL-ELIGIBLE-RESOURCE-BOUNDED-CONTINUOUS-REPRESENTATION / 1 authorized / 1 actual
Stage 2 seed block = 32120001..32120384 / CONSUMED / NO RERUN
Stage 2 candidate population = 48 Namua + 48 Mtaji / 96 complete
Stage 2 preflight eligible = 48 Namua + 47 Mtaji
Stage 2 measured population = 36 Namua + 36 Mtaji / 72 complete
...
repository integration = COMPLETE via G3-10 combined fast-forward to main / source tip 28b64d1cb02904e0c57886ae2046cd681ab64387
```
