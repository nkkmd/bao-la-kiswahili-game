# Study 1 Final Report — LGTGMIV-STUDY1
...
## 3. Immutable representation contract
...
- RAW-state / move canonical serialization determinism
- traversal / legal-move / root order invariance
- repeat-run determinism
- production / structurally independent implementation exact agreement
- family/root/stage digest agreement
...
## 6. Stage 2 — fresh formal holdout
...
- selected population: Namua 12 + Mtaji 12 = 24 unique RAW roots
- relative horizon: depth 5
...
- RAW reachable graph geometry
- transposition / reconvergence structure
- tree / graph divergence relation
