...
Stage 2 support-group selection = OPEN / PENDING
Stage 2 formal measurement = NOT YET PERFORMED
...
No candidate has yet been confirmed or rejected. The next permissible action is frozen outcome-blind support-group selection. Formal measurement remains blocked until the selection artifact is inspected and accepted.
