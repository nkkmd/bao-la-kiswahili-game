...
> **Phase 7更新:** この表はPhase 1時点の短期評価順位を保存したものである。その後の全14 North応手固定継続では、4初手すべてが応手頑健性基準に未達だった。最上位は`index 6 / right`の合計14/24勝・最悪応手2/6勝で、一般定石候補は残っていない。現在の判定は[全応手比較](ALL_REPLY_RESULTS.md)を参照。
