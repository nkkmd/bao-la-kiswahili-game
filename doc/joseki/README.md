...
現在は4 ply全数調査、旧候補の8 ply重点検証、MCTS頑健性試験、主要系列・全4初手・全14 North応手の継続自己対局、C0評価反転分析、8 ply局面パターン横断集計を完了した。全14応手×6条件の84局では、4初手すべてが事前の応手頑健性基準に未達だった。最上位の7番穴・右も合計14/24勝に対して最悪応手2/6勝であり、標準初期局面の一般定石候補は残っていない。暫定定石は認定していない。
