...
現在は4 ply全数調査、旧候補の8 ply重点検証、MCTS頑健性試験、主要系列・全4初手・全14 North応手の継続自己対局、条件付きP001、C0評価反転分析、8 ply局面パターン横断集計を完了した。全4初手が応手頑健性基準に未達し、最上位初手の最悪応手後にも4/6勝以上の第3手はなかった。標準初期局面の一般定石候補とP001条件付き候補は残っていない。暫定定石は認定していない。
