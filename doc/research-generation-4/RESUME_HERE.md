...
7. [`../DOCUMENTATION_LANGUAGE_POLICY.md`](../DOCUMENTATION_LANGUAGE_POLICY.md)と[`../JAPANESE_DOCUMENTATION_QUALITY_GATE.md`](../JAPANESE_DOCUMENTATION_QUALITY_GATE.md)を読む。
...
G4-01 research branchは研究完了状態にあるが、`main`統合はまだ承認されていない。

統合前には次を再確認する。

- canonical result / provenance / attestationが一致していること
- G4-01 closure decisionが存在すること
- `CURRENT_STATUS.md`、Study README、Research Generation 4状態文書が整合していること
- root README、`doc/RESEARCH_INDEX.md`、`doc/FUTURE_RESEARCH_AGENDA.md`に更新漏れがないこと
- PR #151が研究完了状態を正確に説明していること
