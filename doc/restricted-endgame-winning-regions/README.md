# 限定終盤のexact winning region — `REWR-STUDY1`
...
研究開始時のmain HEAD: `626480507710e0095ef8aec6a53c3e4e0318fa4f`
研究ブランチ: `research/restricted-endgame-winning-regions`
Tracking PR: #38
...
- [`STUDY_1_FINAL_REPORT.md`](STUDY_1_FINAL_REPORT.md) — 科学的・技術的な最終統合
- `results/STAGE_1_EXACT_RESULT.json` — 8状態すべてのcanonical exact oracle
- [`CURRENT_STATUS.md`](CURRENT_STATUS.md) — closure状態と固定境界
- [`DECISION_REGISTER.md`](DECISION_REGISTER.md) — immutable design decisions
- [`REPRODUCIBILITY_INDEX.md`](REPRODUCIBILITY_INDEX.md) — source / graph / workflow / result hashes
...
このbounded oracleは、後続のSymmetry / Isomorphic Positions StudyとState Space / Game Tree Complexity Studyでraw ground truthとして使用するために整備しました。
