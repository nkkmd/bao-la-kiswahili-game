...
2026年9月22日に終了した[Jev × AI-GEN4比較試験](../jev-ai-gen4-comparison/README.md)は、64局が32勝32敗、全32ペアが1勝1敗で、正式判定は`INCONCLUSIVE`だった。これは優劣を確認できなかった結果で、同等性の証明ではない。試験版は結果にかかわらず非採用であり、本書の正式release、公開コード、配信状態は変更しない。
