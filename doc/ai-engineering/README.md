...
Direct Policy Studyの判定は固定した`jev-1.13.0`、prompt、candidate表現、Direct Policy方式に限定する。Jev一般、別model version、別prompt、別統合方式へ一般化しない。`NO-PRODUCTION-ADOPTION-FROM-THIS-STUDY`を維持する。
