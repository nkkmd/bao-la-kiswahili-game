...
## 3. Reserved scientific seed blocks
...
## 6. Stage 0 — technical feasibility / semantics validation
...
- upstream D3 evaluator / score quantization / top-set semantics
- comparator / paired construction semantics
...
- runtime、memory、artifact size、shard、upload/transfer、workflow timeout
- runner-local final exact comparisonとmandatory artifact completeness

Stage 0ではG2-09の科学的seedを消費しない。

## 7. Stage 1 — fresh development / boundary construction
...
## 8. Stage 2 — fresh held-out formal validation
...
## 9. Primary endpoint families

Stage 1 specでexact computationを固定するが、conceptual familyは以下とする。

1. structural replication / structural counterexample
2. reference-search tactical-value support / tactical counterexample
3. comparator / paired consistency
4. boundary-group support and counterexample rate
5. source-policy / phase / state-family consistency
...
### Stage 2 / Study scientific terminal candidates
