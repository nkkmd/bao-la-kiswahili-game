...
// Root README: current-facing RG3 and G3-02 entries only.
{
...
// Future agenda: top current state and final current-status section only.
{
...
// Research index: RG3 item 30 and the future-state summary only.
{
