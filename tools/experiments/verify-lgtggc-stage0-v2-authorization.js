...
const AUTH_PATH = "doc/local-game-tree-geometry-generalization-counterexample/authorizations/STAGE_0_TECHNICAL_V2_AUTHORIZATION.json";
const EXEC_PATH = "doc/local-game-tree-geometry-generalization-counterexample/authorizations/STAGE_0_TECHNICAL_V2_EXECUTE.json";
...
need(auth.stageId==="LGTGGC-S0-TECHNICAL-2026-09-04-v2","stage mismatch");
...
need(exec.authorizationFileSha256===fileSha256(AUTH_PATH),"authorization file sha256 mismatch");
