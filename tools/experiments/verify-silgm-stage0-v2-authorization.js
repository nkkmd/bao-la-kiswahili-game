...
const AUTH = path.join(ROOT, "doc/search-instability-local-geometry-mechanism/authorizations/STAGE_0_TECHNICAL_AUTHORIZATION_V2.json");
const TRIGGER = path.join(ROOT, "doc/search-instability-local-geometry-mechanism/authorizations/silgm-stage0-v2-trigger.txt");
...
function main(){
  ...
  need(a.stageId==="SILGM-S0-TECHNICAL-2026-09-03-v2","stage mismatch");
  ...
  need(parent===a.expectedToolingCommit,"trigger parent is not frozen v2 tooling commit");
  ...
  const wrapper=fs.readFileSync(path.join(ROOT,"tools/experiments/run-silgm-stage0-technical-v2.js"),"utf8");
  ...
  need(!wrapper.includes("31710001")&&!wrapper.includes("31720001"),"fresh scientific seed literal present in v2 wrapper");
