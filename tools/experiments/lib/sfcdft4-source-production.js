...
function domainId(policyId,familyId){if(policyId===P1&&familyId===RF1)return'SFCDFT4-D1-P1-RF1';if(policyId===P1&&familyId===RF2)return'SFCDFT4-D2-P1-RF2';if(policyId===P2&&familyId===RF1)return'SFCDFT4-D3-P2-RF1';if(policyId===P2&&familyId===RF2)return'SFCDFT4-D4-P2-RF2';throw new Error('unknown domain');}
