...
function domainId(policyId,familyId){const m=new Map([[`${P1}|${RF1}`,'SFCDFT4-D1-P1-RF1'],[`${P1}|${RF2}`,'SFCDFT4-D2-P1-RF2'],[`${P2}|${RF1}`,'SFCDFT4-D3-P2-RF1'],[`${P2}|${RF2}`,'SFCDFT4-D4-P2-RF2']]);const v=m.get(`${policyId}|${familyId}`);assertOk(v,'independent unknown domain');return v;}
