...
const {
  sourceFileHashes,
  summarizeGames,
} = require("./run-position-typology-smoke.js");
...
function main() {
  ...
  if (manifest.formalExperiment !== false || manifest.clusteringAuthorized !== false) {
    throw new Error("Smoke manifest must remain non-formal and clustering-disabled");
  }
