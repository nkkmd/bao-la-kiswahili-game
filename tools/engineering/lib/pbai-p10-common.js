...
const DOC=path.join(ROOT,'doc/ai-engineering/public-ai-improvement-program-10');
const OUT=path.join(ROOT,'artifacts/pbai-p10/run');
...
function requireSupervision(){if(process.env.PBAI_P10_SUPERVISED!=='1')throw Error('Use PBAI-P10 supervisor');}
let knownCache;
