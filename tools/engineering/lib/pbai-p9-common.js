...
const DOC=path.join(ROOT,'doc/ai-engineering/public-ai-improvement-program-9');
const OUT=path.join(ROOT,'artifacts/pbai-p9/run');
...
function requireSupervision(){if(process.env.PBAI_P9_SUPERVISED!=='1')throw Error('Use PBAI-P9 supervisor');}
let knownCache;
