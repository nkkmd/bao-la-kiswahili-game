...
const C=require("./lib/pbai-p5-common.js"); // Only frozen baseline loading and paths.
...
const B=C.baseline(),names=["development","validation","holdout"],prior=read(C.DOC+"/KNOWN_DATA_EXCLUSIONS.json").rows;
