"use strict";
const CACHE = "bao-la-kiswahili-v34";
const FILES = ["./", "./index.html", "./style.css", "./locale.js", "./engine.js", "./ai-weights.js", "./ai.js", "./logic-evaluator.js", "./ai-config.js", "./ai-worker.js", "./diagnostics.js", "./review-suggestion.js", "./diagnostic-download.js", "./main.js", "./manifest.webmanifest", "./icon.svg", "./privacy"];
