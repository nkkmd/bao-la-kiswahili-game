...
- [`doc/blunder-misvaluation-patterns/STUDY_1_OVERVIEW.md`](doc/blunder-misvaluation-patterns/STUDY_1_OVERVIEW.md): Blunder / Misvaluation Patterns Study 1「悪手・誤評価パターンの発見と体系化」の初見向け成果概要（Stage 1 exploratory discovery完了、4候補promotion、未確認）
