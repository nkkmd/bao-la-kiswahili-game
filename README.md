...
- [`doc/research-program-decisions/2026-09-01-lgtgmiv-closure-and-g3-02-review-required.md`](doc/research-program-decisions/2026-09-01-lgtgmiv-closure-and-g3-02-review-required.md): `LGTGMIV-STUDY1`のformal closureを受理し、G3-02を自動開始せず別authorization reviewを要求するcurrent program decision。
