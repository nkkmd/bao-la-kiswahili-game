...
- [`doc/practical-comeback-error-inducing-moves/STUDY_1_OVERVIEW.md`](doc/practical-comeback-error-inducing-moves/STUDY_1_OVERVIEW.md): Practical Comeback / Error-Inducing Move Study 1（`PCEM-STUDY1`）。2026-08-25研究開始、Stage 0 technical-only未実行、scientific result未生成
